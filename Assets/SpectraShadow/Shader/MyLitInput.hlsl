...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float3, _ShadowOffset)
    UNITY_DOTS_INSTANCED_PROP(float3, _ShadowColor)
...
static float3 unity_DOTS_Sampled_Offset;
static float3 unity_DOTS_Sampled_Color;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_Offset               = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float3, _ShadowOffset);
    unity_DOTS_Sampled_Color                = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float3, _ShadowColor);
}
...
#define _ShadowOffset                 unity_DOTS_Sampled_Offset
#define _ShadowColor                  unity_DOTS_Sampled_Color
